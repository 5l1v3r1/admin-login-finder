...
url = input("Enter the url you wan't to search.\nExample: vulnwebsite.com\nEnter url: ")

urlekleri = ('admin/','administrator/','wp-login.php','login.php','administration/','admin1/','admin2/','admin3/','admin4/','admin5/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
for payload in urlekleri:
    print("Tested URL's: ",payload)
    urls = "https://"+ url +"/"+str(payload)
    sonuc = requests.get(url=urls)
    if str(payload) in str(sonuc.content):
        print("Potantial Admin Login:", str(payload))
        uyku(1)
     
    else:
        print("Url didn't worked: ", payload)
        uyku(1)
